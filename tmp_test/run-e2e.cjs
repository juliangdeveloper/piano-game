...
(async () => {
  const browser = await chromium.launch({
    args: [
      ...
      '--use-file-for-fake-audio-capture=C:/Users/Rog/Workspace/01_PROYECTOS/piano-game/tmp_test/piano-test.wav',
    ]
  });
  ...
  await page.screenshot({ path: 'C:/Users/Rog/Workspace/01_PROYECTOS/piano-game/tmp_test/e2e-result.png' });

  console.log(JSON.stringify({ version, micChecked, hint, rowsCount: rows.length, rows, consoleErrors: errors }, null, 2));
  await browser.close();
})();
